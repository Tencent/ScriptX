...
Modern language features, refer to null pointer safety (nullibility safety please refer to the concept of kotlin).
...
## 5. Simple and efficient binding API
...
[Performance test code] (TODO: update link)
...
1. Hundreds of test cases, **single test coverage rate reaches 87%**
